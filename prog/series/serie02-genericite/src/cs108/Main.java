...
public final class Main {
    public static void main(String[] args) {
        ...
        // votre avancement.
        // ImageRGB<ColorRGB> image = Chessboard.IMAGE;
        ImageRGB<ColorRGB> redDiskImage = RedDisk.IMAGE;
        ImageRGB<ColorRGB> rotatedImage = new Rotated<>(Chessboard.IMAGE, 10);
        HorizontalGradientMask mask = new HorizontalGradientMask();
        ImageRGB<ColorRGB> image = new Composed(redDiskImage, rotatedImage, mask);
    ...
    private static final class ImageComponent extends JComponent {
        private final ImageRGB<ColorRGB> image;
        private final double centerX, centerY;
        private final double width;

        public ImageComponent(ImageRGB<ColorRGB> image, double centerX, double centerY, double width) {
            this.image = image;
