...
public class BurrowsWheelerTransformTest {
    ...
    public void canIDecode() {
        ...
        assertEquals("Les familles heureuses se ressemblent toutes ; les familles malheureuses sont malheureuses chacune à leur façon.", BurrowsWheelerTransform.backward(mBWT));
    }
}
